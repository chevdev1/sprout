// Stroke-based icons, 1.7px stroke on a 24px grid — same convention as
// the landing page's inline SVGs (site/index.html feature/step icons).
...
export function GrowBackIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
