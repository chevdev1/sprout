...
// Both required before the real charge can run.
//
// TREASURY_ADDRESS: where the $5 issuance fee lands (see
// sprout-dashboard-concept.md 3.4.C). USDG_ADDRESS: USDG's contract on
// Robinhood Chain MAINNET — copied by hand from
// docs.robinhood.com/chain/contracts (not auto-fetched) precisely
// because a wrong character here would misdirect real money.
